defmodule Splendor.Hand do
    ...
    defstruct points: 0, chips: %{black: 0, blue: 0, gold: 0, green: 0, red: 0, white: 0, count: 0}, bought: [], reserved: []
    ...
    def get_chips(hand, chips), do: %Hand{chips: change(hand.chips, chips)}
